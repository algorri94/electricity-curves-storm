...
public class SaveCurve implements IBasicBolt{
    ...
    private void saveCurve(Session conn, Curve curve) {
            conn.execute("INSERT INTO curvas (CUPS,DIA,VALOR_H01,VALOR_H02,VALOR_H03,VALOR_H04,VALOR_H05," +
                    ...
                    "PRL_H22,PRL_H23,PRL_H24,PRL_H25,created, before_select_consumption, after_select_consumption, after_select_profile,inserted) VALUES("+
                    "'"+curve.getCups()+"',"+
                    "'"+curve.getDia()+"',"+
                    ...
                    curve.getCreated().getTime() +","+
                    curve.getBefore_select_consumption() +","+
                    curve.getAfter_select_consumption()+","+
                    curve.getAfter_select_profile()+",toTimestamp(now()))");
    }
}
